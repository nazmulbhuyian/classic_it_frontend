...
const Login = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (checkBox == false) {
            ...
            fetch(
                "https://glorious-boa-earrings.cyclic.app/api/v1/userLog",
                {
                    method: "POST",
                    headers: {
                ...
                .then((data) => {
                    if (data.success === true) {
                        ...
                        localStorage.setItem('lluMeMallLoginToken', data.lluMeMallLoginToken);
                        navigate("/");
                        ...
                        <div className="mt-8 lg:w-1/2 lg:mt-0 px-10 ">
                            <div className="form-login pt-[31px] pb-[102px] px-[70px]">
                                <div className="flex justify-center">
                                    <h2 className="text-[30px] text-white font-bold">Log In</h2>
                                </div>
